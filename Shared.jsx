  ...
  return (
    <button onClick={onClick}
      ...
      style={{ display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: 8,
        ...
        boxShadow: hover ? `${sharedStyles.glowCTA}, 0 8px 32px rgba(99,102,241,0.4)` : sharedStyles.glowCTA,
...
function Badge({ children, color = 'orange' }) {
  const colors = {
    orange: { bg: 'rgba(99,102,241,0.15)', text: '#6366F1', border: 'rgba(99,102,241,0.35)' },
...
function SectionLabel({ children, color = 'orange' }) {
  const lineColor = color === 'cyan' ? C.cyan : color === 'green' ? C.green : C.orange;
  return (
...
function ModuleIcon({ icon, color }) {
  const iconMap = {
    ...
    music: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M9 18V5l12-2v13"/><circle cx="6" cy="18" r="3"/><circle cx="18" cy="16" r="3"/></svg>,
    mic: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 2a3 3 0 0 1 3 3v7a3 3 0 0 1-6 0V5a3 3 0 0 1 3-3z"/><path d="M19 10v2a7 7 0 0 1-14 0v-2"/><line x1="12" y1="19" x2="12" y2="22"/></svg>,
    ...
    audio: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><polygon points="11 5 6 9 2 9 2 15 6 15 11 19 11 5"/><path d="M19.07 4.93a10 10 0 0 1 0 14.14"/><path d="M15.54 8.46a5 5 0 0 1 0 7.07"/></svg>,
    ...
    qr: <svg width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><rect x="3" y="3" width="5" height="5" rx="1"/><rect x="16" y="3" width="5" height="5" rx="1"/><rect x="3" y="16" width="5" height="5" rx="1"/><path d="M21 16h-3v3"/><path d="M15 21v-6h3"/><path d="M15 3v3h3"/><path d="M9 9h3v3H9z"/></svg>,
  ...
  return <div style={{ color }}>{iconMap[icon] || iconMap.star}</div>;
}

Object.assign(window, { C, sharedStyles, BtnPrimary, BtnOutline, Badge, SectionLabel, GradientText, ModuleIcon });
